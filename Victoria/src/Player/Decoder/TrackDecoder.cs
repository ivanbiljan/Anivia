...
public readonly struct TrackDecoder {
    ...
    /// <returns></returns>
    public static Task<IEnumerable<LavaTrack>> DecodeAsync(
        NodeConfiguration nodeConfiguration,
        params string[] trackHashes)
        => DecodeAsync(nodeConfiguration, (IEnumerable<string>)trackHashes);
    ...
    public static Task<IEnumerable<LavaTrack>> DecodeAsync(
        ...
        return VictoriaExtensions.ReadAsJsonAsync<IEnumerable<LavaTrack>>(
            requestMessage,
