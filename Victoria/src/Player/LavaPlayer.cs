...
public class LavaPlayer<TLavaTrack> : IAsyncDisposable
    ...
    public Task PlayAsync(Action<PlayArgs<TLavaTrack>> playArgsAction) {
        ...
        return (Volume = playArgs.Volume) switch {
            ...
            _ => _socketClient.SendAsync(
                new PlayPayload<TLavaTrack>(_guildId, playArgs),
                false,
    ...
    public Task PlayAsync(TLavaTrack lavaTrack) {
        ...
        return _socketClient.SendAsync(
            new PlayPayload<TLavaTrack>(
                _guildId,
                new PlayArgs<TLavaTrack> {
                    Track = lavaTrack,
                    Volume = 100,
                    ShouldPause = false
                }),
    ...
    ///     Throws when <paramref name="seekPosition" /> is greater than
    ///     <see cref="Track" /> length.
    /// </exception>
