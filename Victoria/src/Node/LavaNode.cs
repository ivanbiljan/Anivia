...
public class LavaNode<TLavaPlayer, TLavaTrack> : IAsyncDisposable
    ...
    /// <summary>
    ///     Starts a WebSocket connection to the specified <see cref="NodeConfiguration.Hostname" />:
    ///     <see cref="NodeConfiguration.Port" />
    ...
    ///     <see cref="bool" />
    /// </returns>
    public bool HasPlayer(IGuild guild) => _playerCache.ContainsKey(guild.Id);
    ...
    public async Task<SearchResponse> SearchAsync(SearchType searchType, string query) {
        ...
        var urlPath = searchType switch {
            ...
            SearchType.Direct or _  => $"/loadtracks?identifier={HttpUtility.UrlEncode(query)}"
        };
    ...
    ///     <see cref="bool" />
    /// </returns>
    public bool TryGetPlayer(IGuild guild, out TLavaPlayer player) => _playerCache.TryGetValue(guild.Id, out player);
            ...
            switch (VictoriaExtensions.GetOp(root)) {
                ...
                case "playerUpdate":
                    ...
                    await OnUpdateReceived.Invoke(
                        new UpdateEventArg<TLavaPlayer, TLavaTrack> {
                            Player = player,
                            Track = player.Track,
                ...
                case "event": {
                    ...
                    switch (type) {
                        case "TrackStartEvent":
                            ...
                            await OnTrackStart.Invoke(
                                new TrackStartEventArg<TLavaPlayer, TLavaTrack> {
                                    Player = player,
                                    Track = lavaTrack
                                });
                        ...
                        case "TrackEndEvent":
                            ...
                            await OnTrackEnd.Invoke(
                                new TrackEndEventArg<TLavaPlayer, TLavaTrack> {
                                    Player = player,
                                    Track = lavaTrack,
                        ...
                        case "TrackExceptionEvent":
                            ...
                            await OnTrackException.Invoke(
                                new TrackExceptionEventArg<TLavaPlayer, TLavaTrack> {
                                    Player = player,
                                    Track = lavaTrack,
                        ...
                        case "TrackStuckEvent":
                            ...
                            await OnTrackStuck.Invoke(
                                new TrackStuckEventArg<TLavaPlayer, TLavaTrack> {
                                    Player = player,
                                    Track = lavaTrack,
                        ...
                        case "WebSocketClosedEvent":
                            ...
                            await OnWebSocketClosed.Invoke(
                                new WebSocketClosedEventArg {
