...
public static class VictoriaExtensions {
    ...
    /// </returns>
    public static IServiceCollection AddLavaNode(
    ...
    /// <returns></returns>
    public static IServiceCollection AddLavaNode<TPlayer>(
        this IServiceCollection serviceCollection,
        Action<NodeConfiguration> action = default)
    ...
    /// <returns></returns>
    public static IServiceCollection AddLavaNode<TPlayer, TTrack>(
        this IServiceCollection serviceCollection,
        Action<NodeConfiguration> action = default)
    ...
    ///     <see cref="string" />
    /// </returns>
    public static ValueTask<string> FetchArtworkAsync(this LavaTrack track) => ArtworkResolver.FetchAsync(track);
    ...
    public static ValueTask<string> FetchLyricsFromGeniusAsync(this LavaTrack track)
        => LyricsResolver.SearchGeniusAsync(track);
    ...
    public static ValueTask<string> FetchLyricsFromOvhAsync(this LavaTrack track)
        => LyricsResolver.SearchOvhAsync(track);
    ...
    public static async Task<JsonElement> GetJsonRootAsync(
    ...
    internal static string Encode(this string str) => WebUtility.UrlEncode(str);

    internal static string GetOp(JsonElement jsonElement)
        => !jsonElement.TryGetProperty("op", out var element) ? default : $"{element}";
